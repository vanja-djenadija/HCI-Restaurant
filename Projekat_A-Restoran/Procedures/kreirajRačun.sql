CREATE DEFINER=`root`@`localhost` PROCEDURE `kreirajRačun`(in idNarudžba INTEGER, out računId INTEGER)
BEGIN
    ...
    INSERT INTO račun(UkupnaCijena, Datum, ZAPOSLENI_IdZaposleni) VALUES (cijenaRačuna, now(), idZaposleni);
