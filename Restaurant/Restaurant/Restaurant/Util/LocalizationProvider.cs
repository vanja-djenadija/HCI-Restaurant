            ...
            public ResourceAndCulture(string baseName = "", string cultureName = "")
            {
                if (baseName == string.Empty || cultureName == string.Empty)
                {
                    ...
                    switch (AppSettings.AppLanguage)
                    {
                        case "Serbian":
                            {
                                newBaseName = "Restaurant.Resources.sr-RS";
                                newCultureName = "sr";
                                break;
                            }
                        default:
                            {
                                newBaseName = "Restaurant.Resources.en-US";
                                newCultureName = "en";
                                break;
                            }
                    }
        ...
        public static void UpdateAllObjects()
        {
            ...
            foreach (DependencyObject obj in _contentObjects)
            {
                ...
                if (resourceValue != null)
                {
                    ...
                    else if (cctrl.GetType() == typeof(TextBox))
                    {
                        cctrl.SetValue(MaterialDesignThemes.Wpf.HintAssist.HintProperty, resourceValue);
                    }
                    else if (cctrl.GetType() == typeof(PasswordBox))
                    {
                        cctrl.SetValue(MaterialDesignThemes.Wpf.HintAssist.HintProperty, resourceValue);
                    }
                    else if (cctrl.GetType() == typeof(Button))
                    {
                        cctrl.SetValue(Button.ContentProperty, resourceValue);
                    }
                    else if (cctrl.GetType() == typeof(ComboBoxItem))
                    {
                        cctrl.SetValue(ComboBoxItem.ContentProperty, resourceValue);
                    }
                    else if (cctrl.GetType() == typeof(ComboBox))
                    {
                        cctrl.SetValue(MaterialDesignThemes.Wpf.HintAssist.HintProperty, resourceValue);
                    }
                    else if (cctrl.GetType() == typeof(TabItem))
                    {
                        cctrl.SetValue(TabItem.HeaderProperty, resourceValue);
                    }
                    else if (cctrl.GetType() == typeof(DatePicker))
                    {
                        cctrl.SetValue(MaterialDesignThemes.Wpf.HintAssist.HintProperty, resourceValue);
                    }
                    else
